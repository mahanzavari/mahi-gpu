...
wire id_reg_we, id_mem_re, id_mem_we, id_nzp_we, id_rs_re, id_rt_re, id_rd_re; 
wire [1:0] id_reg_mux; wire [3:0] id_alu_arith_mux; 
...
reg ex_rs_re, ex_rt_re, ex_reg_we, ex_mem_re, ex_mem_we, ex_nzp_we;
reg [1:0] ex_reg_mux;
reg [3:0] ex_alu_arith_mux; 

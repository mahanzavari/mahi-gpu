...
module pc #(
    ...
    parameter DEBUG = 0  // Added cleanly globally
) (
    input wire clk,
    input wire reset,
    ...
    always @(posedge clk) begin
        if (reset) begin
            ...
            if (decoded_pc_mux && !decoded_call) begin
                if (DEBUG) $display("[%0t] [PC] Warp %0d BR: NZP=%b Cond=%b %s", 
